...
/// Modifier flags for the hotkey (option/alt key).
/// Uses CGEventFlags values: kCGEventFlagMaskAlternate = 0x00080000.
pub const HOTKEY_MODIFIER_FLAGS: u64 = 0x00080000;
